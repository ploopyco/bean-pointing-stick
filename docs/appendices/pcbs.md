...
Getting the Ploopy boards made can be complex, and expensive, especially if you only need one set. [That's why we sell fully-assembled Beans](https://ploopy.co/product-category/Bean/). Here's why that's great for you:
...
Want to make your own Ploopy Bean boards? Great! Less work for us. Seriously, though, only choose this option if you know what you're doing. You don't want to embarrass yourself, do you?
